...
import { uploadSpaceItems } from '../../Api';
...
export default function UploadItemsModal({ space, token, folderId = null, onClose }: UploadItemsModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await uploadSpaceItems({ spaceId: space.id, formData, token });
